...
struct PDFA3ValidatorTests {
    ...
    func initializeLevelA() async throws {
        let validator = try PDFA3Validator.levelA()
    ...
    func initializeLevelB() async throws {
        let validator = try PDFA3Validator.levelB()
        let conformance = validator.conformance
    ...
    func initializeLevelU() async throws {
        let validator = try PDFA3Validator.levelU()
        let conformance = validator.conformance
    ...
    func levelRequirements() async throws {
        let validatorA = try PDFA3Validator.levelA()
        let validatorU = try PDFA3Validator.levelU()
        let validatorB = try PDFA3Validator.levelB()
    ...
    func multipleValidators() async throws {
        let v1 = try PDFA3Validator.levelA()
        let v2 = try PDFA3Validator.levelB()
        let v3 = try PDFA3Validator.levelU()
