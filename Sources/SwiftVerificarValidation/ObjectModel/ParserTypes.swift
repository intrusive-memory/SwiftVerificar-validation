...
public struct ASAtom: Sendable, Hashable, Comparable, CustomStringConvertible {
    ...
    public static let cMapName = ASAtom("CMapName")
    public static let cidSystemInfo = ASAtom("CIDSystemInfo")
    public static let widths = ASAtom("Widths")
    public static let firstChar = ASAtom("FirstChar")
    public static let lastChar = ASAtom("LastChar")
    public static let fontFile = ASAtom("FontFile")
    public static let fontFile2 = ASAtom("FontFile2")
    public static let fontFile3 = ASAtom("FontFile3")
    public static let flags = ASAtom("Flags")
    public static let italicAngle = ASAtom("ItalicAngle")
    public static let fontBBox = ASAtom("FontBBox")
    public static let cidToGIDMap = ASAtom("CIDToGIDMap")
    public static let dw = ASAtom("DW")
